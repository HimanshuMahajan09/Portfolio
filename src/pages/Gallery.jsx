...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Where every step tells a story — Torna Fort. 🏞️",
      photos: ["/gallery/personal.jpg", "/gallery/fort.jpg"],
    },
    {
      id: 2,
      caption:
        "Where the Sahyadris feel endless. 🌄 — Rajgad.",
      photos: ["/gallery/friends.jpg", "/gallery/me.jpg"],
    },
  ],
  projects: [
    // {
