  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <strong>Himanshu Mahajan</strong> — an aspiring{" "}
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  MCA in web development and machine learning.
                </h4>
                <p
                  style={{
                    color: "rgba(255,255,255,0.85)",
                ...
                >
                  <strong>DR.D.Y.PATIL VIDYAPEETH</strong> — Pune,
                  Maharashtra
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  2nd Year (Pursuing) | GPA: 8.45
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Macro Vision Academy School</strong> — Raver, Maharashtra
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Macro Vision Academy School</strong> — Raver,
                  Maharashtra
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  CBSE Board | Percentage: 62.3%
                </p>
