...
const PROJECTS = [
  {
    title: 'CourseEra(Online Course Selling Platform)',
    desc: 'Developed a full-stack application with React.js and Node.js (Express), implementing secure JWT authentication, role-based access, Stripe payments, and optimized MongoDB-powered APIs with a responsive UI.',
    ss: '/mamo.png',
    tech: ['MERN Stack', 'Stripe API', 'JWT Authentication'],
    live: '#',
    code: 'https://github.com/HimanshuMahajan09/coursera-service.git',
  },
  {
  title: 'MiniDrive – Cloud Storage Solution',
  desc: 'MiniDrive is a full-stack file storage web application that allows users to securely upload, manage, and access files through a clean and responsive interface, focusing on simplicity, security, and usability.',
  ss: '/mentalhealth.jpg',
  tech: ['React.js', 'Node.js', 'Express', 'MongoDB'],
  live: '#',
  code: 'https://github.com/HimanshuMahajan09/Mini-Drive.git'
  },
  // {
  ...
  live: '#',
  code: 'https://github.com/HimanshuMahajan09/Portfolio-Website.git'
  },
  // {
    ...
    >
      <div className="card" style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 16, padding: 30 }}>
        ...
        <p className="text-gray-400 mb-10">
          A collection of my major works — blending research.
        </p>
