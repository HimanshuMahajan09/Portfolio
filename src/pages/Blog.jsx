...
export default function Blog() {
  const defaultPosts = [
    ...
    },
    {
      ...
      text: "I believe good design is a balance between usability and visual appeal. I’m drawn to clean, minimalist layouts and dark themes that create a modern, focused, and engaging user experience.",
    },
    {
      id: 3,
      title: "Balancing Tech and Creativity",
      text: "As someone who enjoys both coding and dance, I see creativity as a common thread between them. Building software feels like choreography for the mind—where logic, structure, and expression come together to create something meaningful.",
    },
    {
      id: 4,
      title: "The Beauty of Simple Code",
      text: "To me, clean code is about clarity, not just fewer lines. Well-structured functions with clear purpose feel elegant and purposeful—much like poetry written in logic.",
    },
  ];
